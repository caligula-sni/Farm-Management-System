...
<li class="breadcrumb-item active">Provinces</li>
    ...
    <?php
try {
    $pdoQuery = "SELECT * FROM tbprovince";
...
<div class="card">
    ...
    <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach ($rows as $row): ?>
                        <tr>
                            <td>
                                <a href="citymuni.php?province_id=<?= htmlspecialchars($row['province_id']) ?>" class="btn btn-link">
                                    <?= ucwords(strtolower(trim(htmlspecialchars($row['province_name'])))) ?>
                                </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <?php else: ?>
            <p class="text-center text-muted">No provinces found.</p>
        <?php endif; ?>
    </div>
</div>
