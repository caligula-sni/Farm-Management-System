...
<?php
    ...
    try {
        ...
        // Fetch data from the audit trail table 
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Audit Trail Data</h5>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <?php else: ?>
                    <tr>
                      <td colspan="3" class="text-center">No audit trail data available.</td>
                    </tr>
                  <?php endif; ?>
                </tbody>
              </table>
