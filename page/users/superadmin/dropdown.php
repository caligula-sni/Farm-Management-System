<?php
session_start(); // Start the session as the first line of the script
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="crud/search.php">
  ...
  <!-- Dropdown Container -->
   ...
   <div class="pagetitle">
    ...
    <div class="form-group">
            <label for="users" class="dropdown-label">Select Username:</label>
            <?php
            try {
                ...
                // Build the dropdown
                echo "<select name='users' id='users' class='custom-dropdown'>";
                echo "<option disabled selected hidden>usernames</option>"; // Placeholder option
