...
<?php
            ...
            if (!empty($_POST["modify"])) {
                ...
                $pdoQuery = $pdoConnect->prepare("UPDATE tbuser SET UserName = :userName, PassWord = :password, FullName = :fullName, role_id = :roleID, 
...
<!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="col-12">
      ...
      <select id="dropdown" name="Role" id="" class="styled-select" 
      value="<?php echo $pdoResult[0]['role_id']; ?>" required>
